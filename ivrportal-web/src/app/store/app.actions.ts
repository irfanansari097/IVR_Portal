...
import { IvrServiceDto, UserDetail } from './app.state';
...
//IVR SERVICES
export const SETIVRSERVICES = 'Set IVRSERVICES  ';
export const setIVRServices: ActionCreator<customAction> =
  (inivrservices : IvrServiceDto[]) => ({
    type: SETIVRSERVICES,
    payload: inivrservices
  })

  //IVR SERVICES
export const SETIVRCONTENTS = 'Set IVRCONTENTS  ';
export const setIVRContents: ActionCreator<customAction> =
  (inivrcontents : IvrServiceDto[]) => ({
    type: SETIVRCONTENTS,
    payload: inivrcontents
  })